    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          ...
          <form action="Security.php" class="sign-in-form">
            ...
            <button type="button" name="login" value="Login" onclick="location.href='Dashboard/dashboard.php'" class="btn solid">Login</button>
      ...
      <div class="panels-container">
        ...
        <div class="panel right-panel">
          ...
          <img src="img/FR.png" class="image" alt="" />
        </div>
      </div>
    </div>
